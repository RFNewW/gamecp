...
if (!$fp) {
    ...
    if ($res_status == 'verified') {
        ...
        $credits = calculate_credits($config['donations_credit_muntiplier'], $config['donations_number_of_pay_options'], $config['donations_start_price_php'], $config['donations_start_credits_php'], $payment_gross);
